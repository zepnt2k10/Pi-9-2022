...
\begin{multicols}{2}
	...
	\begin{figure}[H]
		...
		\vspace*{-10pt}
	\end{figure}
	Khi đó, tích các số ở mỗi hàng, mỗi cột, mỗi đường chéo chính của bảng đều bằng $12 \cdot 6 \cdot x = 72x$.  Do đó
	\begin{align*}
	...
	\end{align*}
	Vậy, các số dương được dùng để điền vào bảng sao cho yêu cầu của đề bài được thỏa mãn là $18$, $9$, $4$, $2$, $36$, $3$, và chúng được điền như ở bảng dưới đây:
	\begin{figure}[H]
%		\vspace*{-5pt}
		\centering
		\begin{tikzpicture}[color=thachthuctoanhoc, scale=0.7]
	...
	\end{align*}
%	\begin{numcases}
%		$\frac{{{x_0}}}{{{y_0}}} + \sqrt {{x_0}}  = {y_0} + \sqrt {\frac{{{y_0}}}{{{x_0}}}}$ \tag{$2.1$}\\
%		${x_0}{y_0} + {x_0} + {y_0} = 3.$ \tag{$2.2$}
%	\end{numcases}
%\begin{numcases} {}
%	x, & for $x \geq 0$\\
%	-x, & for $x < 0$
